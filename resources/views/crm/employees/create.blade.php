...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("crm.employees.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label class="" for="phone">{{ trans('cruds.employee.fields.phone') }}</label>
            ...
            <div class="form-group">
                ...
                <select name="company_id" id="" class="form-control" required>
                    @foreach($companies as $id => $company)
                        <option value="{{$id}} {{ old('$company') ? 'selected' : '' }}">{{$company}}</option>
                    @endforeach
                </select>
